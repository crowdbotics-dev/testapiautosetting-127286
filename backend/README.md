...
## Project Structure
    ...
    ├── testapiautosetting_127286  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127286`
...
2. Clone this repo and `cd testapiautosetting_127286`
